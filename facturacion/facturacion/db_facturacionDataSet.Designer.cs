...
namespace facturacion {
    ...
    public partial class db_facturacionDataSet : global::System.Data.DataSet {
        ...
        public partial class clientesDataTable : global::System.Data.TypedTableBase<clientesRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public clientesRow AddclientesRow(string codigo, string nombre, string direccion, string telefono, string dui) {
...
namespace facturacion.db_facturacionDataSetTableAdapters {
    ...
    public partial class clientesTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[clientes] WHERE (([idCliente] = @Original_idCliente) AND ((@IsNull_codigo = 1 AND [codigo] IS NULL) OR ([codigo] = @Original_codigo)) AND ([nombre] = @Original_nombre) AND ([direccion] = @Original_direccion) AND ((@IsNull_telefono = 1 AND [telefono] IS NULL) OR ([telefono] = @Original_telefono)) AND ((@IsNull_dui = 1 AND [dui] IS NULL) OR ([dui] = @Original_dui)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[clientes] ([codigo], [nombre], [direccion], [telefono], [dui])" +
                " VALUES (@codigo, @nombre, @direccion, @telefono, @dui);\r\nSELECT idCliente, codi" +
                "go, nombre, direccion, telefono, dui FROM clientes WHERE (idCliente = SCOPE_IDEN" +
                "TITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[clientes] SET [codigo] = @codigo, [nombre] = @nombre, [direccion] = @direccion, [telefono] = @telefono, [dui] = @dui WHERE (([idCliente] = @Original_idCliente) AND ((@IsNull_codigo = 1 AND [codigo] IS NULL) OR ([codigo] = @Original_codigo)) AND ([nombre] = @Original_nombre) AND ([direccion] = @Original_direccion) AND ((@IsNull_telefono = 1 AND [telefono] IS NULL) OR ([telefono] = @Original_telefono)) AND ((@IsNull_dui = 1 AND [dui] IS NULL) OR ([dui] = @Original_dui)));
SELECT idCliente, codigo, nombre, direccion, telefono, dui FROM clientes WHERE (idCliente = @idCliente)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::facturacion.Properties.Settings.Default.db_facturacionConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT idCliente, codigo, nombre, direccion, telefono, dui FROM dbo.clientes";
        ...
        public virtual int Fill(db_facturacionDataSet.clientesDataTable dataTable) {
        ...
        public virtual db_facturacionDataSet.clientesDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            db_facturacionDataSet.clientesDataTable dataTable = new db_facturacionDataSet.clientesDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(db_facturacionDataSet.clientesDataTable dataTable) {
        ...
        public virtual int Delete(int Original_idCliente, string Original_codigo, string Original_nombre, string Original_direccion, string Original_telefono, string Original_dui) {
        ...
        public virtual int Insert(string codigo, string nombre, string direccion, string telefono, string dui) {
            if ((codigo == null)) {
        ...
        public virtual int Update(string codigo, string nombre, string direccion, string telefono, string dui, int Original_idCliente, string Original_codigo, string Original_nombre, string Original_direccion, string Original_telefono, string Original_dui, int idCliente) {
            if ((codigo == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string codigo, string nombre, string direccion, string telefono, string dui, int Original_idCliente, string Original_codigo, string Original_nombre, string Original_direccion, string Original_telefono, string Original_dui) {
            return this.Update(codigo, nombre, direccion, telefono, dui, Original_idCliente, Original_codigo, Original_nombre, Original_direccion, Original_telefono, Original_dui, Original_idCliente);
        }
    }
